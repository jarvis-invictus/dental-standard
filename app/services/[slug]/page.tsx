              ...
              <div className="lg:col-span-2 space-y-8">
                ...
                <div className="bg-primary/10 rounded-2xl p-8 text-center">
                  ...
                  <p className="text-gray-600 mb-6">
                    Book a consultation with our team to discuss your treatment options.
                  </p>
                  <a
                    href={siteConfig.social.whatsapp}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-2 px-8 py-4 bg-primary text-secondary font-bold rounded-full hover:bg-primary/90 transition-colors"
                  >
                    Book via WhatsApp
                  </a>
                </div>
                ...
                <div className="flex gap-3">
                  {prevService && (
                    <Link
                      ...
                      className="flex-1 px-4 py-3 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 transition-colors text-sm font-medium text-center"
                    >
                      ← {prevService.title}
                    </Link>
                  )}
