    ...
    <div className="fixed bottom-0 left-0 right-0 z-50 bg-white border-t md:hidden">
      <div className="flex">
        <a
          ...
          className="flex-1 flex items-center justify-center gap-2 py-3 text-secondary font-medium"
        >
        ...
        <a
          ...
          className="flex-1 flex items-center justify-center gap-2 py-3 bg-primary text-secondary font-bold"
        >
