          ...
          >
            <div className="flex items-center gap-4">
              <div className="flex items-center gap-2 px-4 py-2 bg-primary/10 rounded-full">
                ...
                <span className="text-sm font-medium text-secondary">IDA Certified</span>
              </div>
              <div className="flex items-center gap-2 px-4 py-2 bg-primary/10 rounded-full">
                <Calendar className="w-5 h-5 text-primary" />
                <span className="text-sm font-medium text-secondary">{siteConfig.foundingYear} - Present</span>
              </div>
            </div>
